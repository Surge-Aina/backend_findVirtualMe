      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <p><strong>Services:</strong> ${servicesList}</p>
            <p><strong>Due Date:</strong> ${new Date(formData.dueDate).toLocaleDateString()}</p>
            ${formData.details ? `<p><strong>Additional Details:</strong><br>${formData.details}</p>` : ''}
          </div>
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <table>
              ...
              <tr><td>Due Date:</td><td>${new Date(formData.dueDate).toLocaleDateString()}</td></tr>
              <tr><td>Timestamp:</td><td>${new Date().toLocaleString()}</td></tr>
              ${formData.details ? `<tr><td>Details:</td><td>${formData.details}</td></tr>` : ''}
            </table>
          </div>
        </div>
      </div>
