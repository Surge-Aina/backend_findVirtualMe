...
// Unpublish portfolio
router.post('/my-portfolio/unpublish', authenticate, cleaningController.unpublishPortfolio);

// ===== Services =====
router.post('/my-portfolio/services', authenticate, cleaningController.addService);
router.put('/my-portfolio/services/:serviceId', authenticate, cleaningController.updateService);
router.delete('/my-portfolio/services/:serviceId', authenticate, cleaningController.deleteService);

// ===== Room Pricing =====
router.put('/my-portfolio/room-pricing', authenticate, cleaningController.updateRoomPricing);
...
router.patch('/quotes/:quoteId/status', authenticate, cleaningController.updateQuoteStatus);
