...
jest.mock("../models/seedVendor", () =>
  jest.fn(async () => true)
);

// OpenAI service
jest.mock("../../../shared/services/openAiService", () => ({
...
} = require("../../../shared/services/openAiService");
const vendorRoutes = require("../routes/localVendorRoutes");
