    ...
    jest.mock('../controllers/handymanInquiryController', () => ({
    createInquiry: (req, res) =>
        res.status(201).json({ ok: true, got: req.body || {} }),
    }));

    jest.mock('../controllers/handymanPortfolioController', () => ({
    ...
    jest.mock('../controllers/handymanTemplateController', () => ({
    ...
    const inquiryRoutes = require('../routes/handymanInquiryRoutes');
    const portfolioRoutes = require('../routes/handymanPortfolioRoutes');
    const templateRoutes = require('../routes/handymanTemplateRoutes');
