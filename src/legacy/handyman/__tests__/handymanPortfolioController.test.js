    ...
    const s3 = require('../../../shared/services/s3Service');

    // 2) Now safely require controller & model
    const controller = require('../controllers/handymanPortfolioController');
    ...
    describe('createPortfolioItem -> upload fails after first image', () => {
        ...
        const ctrl = require('../controllers/handymanPortfolioController');
        const req = {
            body: { title: 'X', category: 'Y', templateId: 't1' },
            files: {
            beforeImage: [
