...
jest.mock('../../../legacy/photographer/oauth-handler', () => {
...
jest.mock('../domainResolver', () => mockPassThrough);
jest.mock('../auth', () => mockPassThrough);
jest.mock('../roleCheck', () => () => mockPassThrough);

jest.mock('../../../legacy/healthcare/routes/healthcare_routes', () => mockPassThrough);
jest.mock('../../../legacy/photographer/routes/settingsRoute', () => mockPassThrough);
jest.mock('../../../legacy/photographer/routes/driveRoute', () => mockPassThrough);
jest.mock('../../../legacy/photographer/routes/photoRoute', () => mockPassThrough);
jest.mock('../../../legacy/photographer/routes/uploadRoute', () => mockPassThrough);
jest.mock('../../../../routes/userRoute', () => mockPassThrough);
jest.mock('../../../modules/portfolios/portfolio.routes', () => mockPassThrough);
jest.mock('../../../legacy/project-manager/routes/portfolioRoute', () => mockPassThrough);
jest.mock('../../../legacy/data-scientist/routes/testimonialRoute', () => mockPassThrough);
jest.mock('../../../legacy/data-scientist/routes/dashboardRoute', () => mockPassThrough);
jest.mock('../../../legacy/local-vendor/routes/bannerRoutes', () => mockPassThrough);
jest.mock('../../../legacy/local-vendor/routes/aboutRoutes', () => mockPassThrough);
jest.mock('../../../legacy/local-vendor/routes/menuRoutes', () => mockPassThrough);
jest.mock('../../../legacy/local-vendor/routes/galleryRoutes', () => mockPassThrough);
jest.mock('../../../legacy/local-vendor/routes/reviewRoutes', () => mockPassThrough);
...
jest.mock('../../../legacy/local-vendor/routes/localVendorRoutes', () => mockPassThrough);
jest.mock('../../../modules/payments/subscriptions.routes', () => mockPassThrough);
jest.mock('../../../modules/payments/stripe-webhook.routes', () => mockPassThrough);
jest.mock('../../../modules/support/support.routes', () => mockPassThrough);
jest.mock('../../../modules/domains/domains.routes', () => mockPassThrough);
jest.mock('../../../modules/telemetry/telemetry.routes', () => mockPassThrough);

jest.mock('../../../modules/portfolios/publicPortfolios/publicPortfolios.routes', () => mockPassThrough);
jest.mock('../../../modules/portfolios/userPortfoliosArray/userPortfoliosArray.routes.js', () => mockPassThrough);
jest.mock('../../../modules/media/S3Upload.routes.js', () => mockPassThrough);
jest.mock('../../../modules/payments/domain-payment/stripe/stripe.route', () => mockPassThrough);
...
const oauthHandler = require('../../../legacy/photographer/oauth-handler');
