...
jest.mock('../../../modules/domains/domain.service.js', () => ({
  getDomain: jest.fn(),
...
const domainService = require('../../../modules/domains/domain.service.js');
const domainRoutes = require('../../../modules/domains/domains.routes.js');
