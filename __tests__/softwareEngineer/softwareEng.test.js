...
//       const response = await request(app).get("/software-eng/admin@test.com").expect(200);
...
//       const response = await request(app).get("/software-eng/cust@test.com").expect(200);
...
//       await request(app).put("/software-eng/admin@test.com").send(updateData).expect(200);
