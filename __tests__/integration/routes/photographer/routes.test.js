describe("signupUser", () => {
  test("dummy test just to verify setup", () => {
...
// const settingsRoutes = require("../../../../routes/photographer/settingsRoute.js");
// const userRoutes = require("../../../../routes/userRoute.js");
// const User = require("../../../../models/userModel.js");
// const Settings = require("../../../../models/photographer/settingsModel.js");
...
//         const response = await request(app).get("/settings/heroText").expect(200);
...
//         const response = await request(app).get("/settings/nonExistent").expect(404);
...
//       const allSettingsResponse = await request(app).get("/settings").expect(200);
...
//         request(app).put(`/settings/${settingKey}`).send({ value })
//       );
...
//       const finalResponse = await request(app).get(`/settings/${settingKey}`).expect(200);
